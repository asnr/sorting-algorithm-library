...
obj/sort_lib.o : src/sort_lib.h src/sort_lib.c
	gcc -c src/sort_lib.c -o $@

obj/heap_sort.o : src/heap_sort.h src/heap_sort.c
	gcc -c src/heap_sort.c -o $@

obj/binary_tree_sort.o : src/binary_tree_sort.h src/binary_tree_sort.c
	gcc -c src/binary_tree_sort.c -o $@

obj/red_black_tree_sort.o : src/red_black_tree_sort.h src/red_black_tree_sort.c
	gcc -c src/red_black_tree_sort.c -o $@
